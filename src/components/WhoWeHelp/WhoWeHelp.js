...
function WhoWeHelp() {
    ...
    return (
        ...
        <div className="who-help-info">
            <button className="who-help-btn" id={0} onClick={handleClick}>Fundacjom</button>
            <button className="who-help-btn" id={1} onClick={handleClick}>Organizacjom pozarządowym</button>
            <button className="who-help-btn" id={2} onClick={handleClick}>Lokalnym zbiórkom</button>
        </div>
